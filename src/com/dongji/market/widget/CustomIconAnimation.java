...
//		mTempIcon.setY(iconY - AndroidUtils.dip2px(Search_Result_Activity.this, 2));	//sdk2.3以上才可用
		...
		mParams.topMargin = initY - AndroidUtils.getStatusBarInfo(cxt).top;
		...
		shake.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				...
				int fromX = initX - AndroidUtils.dip2px(cxt, 10);
				int toX = AndroidUtils.getViewLocation(toView)[0] - toView.getWidth()/2;
				int fromY = initY - AndroidUtils.getStatusBarInfo(cxt).top - toView.getHeight()/2;
				int toY = AndroidUtils.getStatusBarInfo(cxt).top;
