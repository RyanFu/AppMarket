...
//			if (!mExpandableListView.isStackFromBottom()) {
//				mExpandableListView.setStackFromBottom(true);
//			}
//			mExpandableListView.setStackFromBottom(false);
		...
		public void run() {
			...
			if (mExpandableListView.getFirstVisiblePosition() > 0) {
				if (mExpandableListView.getFirstVisiblePosition() < AConstDefine.AUTO_SCRLL_TIMES) {
					mExpandableListView.setSelection(mExpandableListView
